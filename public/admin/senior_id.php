		...
		if (!empty($ids)) {
			...
			<head>
				...
				<style>
					...
					.front .hdr .l3 { font-weight:900; font-size: 6.6pt; }
                    ...
                    .front .sig-block { width: 58mm; text-align:center; margin-left: 6mm; }
                    ...
                    .front .ctrl { position:absolute; right:8mm; top:46mm; display:flex; align-items:center; gap: 0.8mm; font-weight:700; font-size:6.8pt; z-index:3; background:#fff; padding: 0 0.3mm; }

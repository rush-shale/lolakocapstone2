		...
		if (!empty($ids)) {
			...
			<head>
				...
				<style>
                    ...
                    .front .header-row { position:absolute; top:1.5mm; left:6mm; right:6mm; display:grid; grid-template-columns: 14mm 1fr 14mm; align-items:center; column-gap: 4mm; z-index:2; }

		...
		if (!empty($ids)) {
			...
			<head>
				...
				<style>
                    ...
                    .front .header-row { position:absolute; top:5mm; left:8mm; right:8mm; display:grid; grid-template-columns: 14mm 1fr 14mm; align-items:center; column-gap: 4mm; z-index:2; }

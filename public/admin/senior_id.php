		...
		if (!empty($ids)) {
			...
			<head>
				...
				<style>
                    ...
                    .front .footer-note { position:absolute; left:0; right:0; bottom:2mm; text-align:center; font-size:6.4pt; font-weight:900; text-transform:none; z-index:3; background:#fff; border-top: 0.2mm solid #000; padding-top: 1mm; }
